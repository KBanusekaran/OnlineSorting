	...
	<div class="generic-container" ng-controller="sort_controller">
		<div class="panel panel-default">
			<div class="panel-heading">
				<span class="lead">Online Sorting </span>
			</div>
				...
				<form name="myForm" class="form-horizontal">
					...
					<div class="row">
						<div class="form-group col-md-12">
							<label class="col-md-2 control-lable" for="file">Enter
								values for Sorting</label>
							<div class="col-md-7">
								<input type="text" ng-model="unSortedList" name="sortD"
									class="username form-control input-sm"
									placeholder="1,12,3,4,5,22226,7,8,319,10" required
									ng-pattern="patternSort" />
								<div class="has-error" ng-show="myForm.$dirty">
									<span ng-show="myForm.sortD.$error.required">This is a
										required field</span> <span ng-show="myForm.sortD.$error.pattern">Looks
										like number's is exceed 9 digits (or) commas(,) are not
										properly placed</span>
								</div>
							</div>
						</div>
					</div>
